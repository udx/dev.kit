...
Core Contract
- Default: AI client must call `dev.kit -p "<user prompt>"` for any user request.
...
- Use `docs/references/codex_prompting_guide.md` as inspiration for concise, tool-first prompts.
