---
name: dev-kit-knowledge-curator
...
## Purpose
Produce a reusable best-practices snapshot and/or capture session learnings in a knowledgebase.
...
## Logic
- Analyze repo evidence sources (README, docs/, prompts, configs).
...
## Schema
- Inputs: repo root, user request, evidence sources
- Outputs: `best_practices/*.md` and/or `docs/knowledge.md`
- Format: Markdown with dated section headers `## YYYY-MM-DD`
...
## Docs
- Assets: (none; use repo-local guidance when present)
