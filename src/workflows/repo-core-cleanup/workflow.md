...
- Remove files/directories not in `src/workflows/repo-core-cleanup/keep-list.txt`.
- Update `README.md` and `docs/index.md` to describe the reduced core.
- Add cleanup artifacts under `src/workflows/repo-core-cleanup/`.

Validation checks:
- `assets/flow.svg` remains present and referenced in core docs.
- All paths in `src/workflows/repo-core-cleanup/keep-list.txt` exist after cleanup.
...
- Repo file tree
Logic/Tooling:
- `codex exec "cat src/workflows/repo-core-cleanup/derive-core-scope/workflow.md"` and follow the child steps.
Expected output/result:
- `src/workflows/repo-core-cleanup/core-scope.md`
- `src/workflows/repo-core-cleanup/keep-list.txt`
- `src/workflows/repo-core-cleanup/open-questions.md` (if any)
Done: false
...
- `docs/index.md`
Logic/Tooling:
- `codex exec "cat src/workflows/repo-core-cleanup/cleanup-and-validate/workflow.md"` and follow the child steps.
Expected output/result:
- `src/workflows/repo-core-cleanup/remove-list.txt`
- `src/workflows/repo-core-cleanup/cleanup-log.md`
- Updated `README.md` and `docs/index.md`
- `src/workflows/repo-core-cleanup/validation-checklist.md`
Done: false
