# AI module context layer

This layer defines AI module metadata and dispatch behavior for AI-related integrations.

<details>
<summary>Prompt(AI module layer builder)</summary>

You are a deterministic converter that transforms a single AI module-layer Markdown document into a single JSON artifact.

Tenet: the Markdown is the configuration and source of truth. This prompt is only the script. Do not embed or assume any AI module-specific content beyond the generic conversion rules below.
...
- Prompt: see `Prompt(AI module layer builder)` in this file.
- Destination: `public/modules/ai.json`.

## Scope

- Applies to AI modules under `src/context/30_module/ai/`.
- Child module layers define module-specific transformation prompts and destinations.

## Skills artifact build

- Source: `src/context/30_module/ai/skills/` (common AI skills).
- Client inputs: `src/context/30_module/ai/<client>/skills.md` (client-specific selection/overrides).
- Output: `public/modules/ai/<client>/skills.md`.
