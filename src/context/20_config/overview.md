...
See `src/context/20_config/specs/module-metadata.md` for the draft module format.
...
See `src/context/20_config/ai/overview.md` for the contract.
See `src/context/20_config/ai/overview.md` for current integration design.

See `src/context/20_config/architecture/dev-kit-design.md` for the current design and architecture.
