...
bin/modules/<module-name>/
  ...
  instructions/
  docs/
src/context/30_module/<domain>/<module>/
  index.md
  overview.md
  workflows.md
...
```json
{
  ...
  "components": {
    "docs": [
      {
        "id": "git.guide",
        "path": "src/context/20_config/guides/git-guide.md",
...
```json
{
  ...
  "docs": [
    {
      "id": "devkit.overview",
      "title": "dev.kit overview",
      "path": "src/context/20_config/overview.md",
      "tags": ["dev.kit", "overview", "design"],
      "summary": "What dev.kit is and how the system is structured."
    }
  ],
  "refs": [
...
Docs as Metadata (v0)
- During early iterations, docs can live in `src/context/` and be indexed by a simple
  mapping table.
