...
- **Mandate**: Use `visualizer` for all diagramming and visual engineering tasks.
- **Mandate**: Use `git-sync` for all repository synchronization and atomic commits.
...
- **Reference**: `docs/workflows/normalization.md` (Task Normalization).
...
- **Workflows**: Consolidated sequences in `docs/workflows/`.
